...
import Client.Messaging.WarControllerFacade;
import Entities.*;
import Client.View.EntitiesViews.*;
import Client.View.subscribers.FXViewSubscriber;
...
public class MainWindowController extends BorderPane implements ViewFacade, Initializable{
    private WarControllerFacade controller = MessageController.getInstance();

    @FXML
    private transient BorderPane container;
    @FXML
    private transient VBox launchersBox;
    @FXML
    private transient VBox missileDestructorsBox;
    @FXML
    private transient HBox planesBox;
    @FXML
    private transient HBox shipsBox;
    @FXML
    private transient VBox targetsBox;
